...
function fr() {
  if (Te) return A;
  Te = 1;
  var O = we, h = Symbol.for("react.element"), j = Symbol.for("react.fragment"), y = Object.prototype.hasOwnProperty, I = O.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, $ = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(_, f, S) {
...
function cr() {
  return Oe || (Oe = 1, process.env.NODE_ENV !== "production" && function() {
    var O = we, h = Symbol.for("react.element"), j = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), I = Symbol.for("react.strict_mode"), $ = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), _ = Symbol.for("react.context"), f = Symbol.for("react.forward_ref"), S = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), R = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), H = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === y || e === $ || Fe || e === I || e === S || e === p || Ae || e === W || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === b || e.$$typeof === x || e.$$typeof === _ || e.$$typeof === f || // This needs to include all possible module reference object
...
` + a[s].replace(" at new ", " at ");
    ...
    var D = Object.prototype.hasOwnProperty, le = {}, fe = w.ReactDebugCurrentFrame;
    function M(e) {
      if (e) {
    ...
    var q = w.ReactCurrentOwner, be = w.ReactDebugCurrentFrame;
    function C(e) {
      if (e) {
        var r = e._owner, t = V(e.type, e._source, r ? r.type : null);
    ...
    function me(e, r, t, n, i, u) {
      {
        ...
        if (D.call(r, "key")) {
          var T = E(e), v = Object.keys(r).filter(function(lr) {
            return lr !== "key";
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`, z, T, sr, T), Re[T + z] = !0;
    ...
    var ir = or, ur = ar;
    F.Fragment = y, F.jsx = ir, F.jsxs = ur;
  }()), F;
}
...
const vr = ({
  onResult: O,
  placeholder: h = "Enter Stellar Address...",
  className: j = ""
}) => /* @__PURE__ */ Se.jsx("div", { className: `relative w-full ${j}`, children: /* @__PURE__ */ Se.jsx(
  "input",
  {
    type: "text",
    ...
    placeholder: h,
    onChange: (y) => {
      O && O({ value: y.target.value, valid: !1 });
    }
  }
) });
export {
